...
namespace Compras
{
    internal class ItemCompra
    {
        ...
        //}
        #endregion
        public void SolicitarDadosItem()
        {
            Console.Write("Informe a descrição do item: ");
            Descricao = Console.ReadLine();

            Console.Write("Informe a quantidade do item (máximo 3 itens): ");
            while (true)
            {
                if (int.TryParse(Console.ReadLine(), out int quantidade) && quantidade > 0 && quantidade <= 3)
                {
                ...
                {
                    Console.WriteLine("Quantidade inválida. Digite um número inteiro positivo menor ou igual a 3.");
                }
            }
            Console.Write("Informe o valor unitário do item: ");
            while (true)
        ...
        //}
        #endregion
        public static ItemCompra LerDados(string linha)
        {
